            ...
            <div>
              ...
              <div>
                <div className='form-group'>
                  <label style={{ color: 'black', top: '5px', fontWeight:'bolder' }}>First Name:</label>
              ...
              <div>
                <div className='form-group'>
                  <label style={{ color: 'black', top: '5px', fontWeight:'bolder' }}>Middle Name:</label>
              ...
              <div>
                <div className='form-group'>
                  <label style={{ color: 'black', top: '5px', fontWeight:'bolder' }}>Last Name:</label>
                ...
                <div>
                  <div className='form-group'>
                    <label style={{ color: 'black', top: '5px', fontWeight:'bolder' }}>Contact Number:</label>
              ...
              <div>
                <div className='form-group'>
                  <label style={{ color: 'black', top: '5px', fontWeight:'bolder' }}>Email:</label>
                ...
                <div>
                  <div className='form-group'>
                    <label style={{ color: 'black', top: '5px', fontWeight:'bolder' }}>Password:</label>
                    <div>
